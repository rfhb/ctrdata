...
package. This README was reviewed on 2023-10-14 for version 1.15.2.9000
...
# - Downloading 899 lists with document information (estimate: 17.98 Mb)
# Download status: 899 done; 0 in progress. Total size: 14.25 Mb (100%)... done!             
# - Processing document information in 899 lists
# - Creating subfolder for each trial
# - Applying 'documents.regexp' to 4460 documents
# - Downloading 418 missing documents
# Download status: 418 done; 0 in progress. Total size: 274.75 Mb (100%)... done!             
# = Newly saved 371 document(s) for 37 trial(s) (latest versions only, deduplicated if 
# e.g. in application and authorised part); 0 document(s) for 0 trial(s) already existed
```
...
# test_ctrdata_ctrfindactivesubstance.R    4 tests OK 4.5s
# test_ctrdata_mongo_local_ctgov.R   36 tests OK 1.2s
# test_ctrdata_mongo_local_ctgov2.R   10 tests OK 20.3s
# test_ctrdata_mongo_local_ctis.R   21 tests OK 3.6s
# test_ctrdata_mongo_local_euctr.R   73 tests OK 2.1s
# test_ctrdata_mongo_local_isrctn.R   31 tests OK 8.1s
# test_ctrdata_other_functions.R   58 tests OK 0.7s
# test_ctrdata_sqlite_ctgov.R...   36 tests OK 4.4s
# test_ctrdata_sqlite_ctgov2.R..   10 tests OK 1.5s
# test_ctrdata_sqlite_ctis.R....   21 tests OK 5.5s
# test_ctrdata_sqlite_euctr.R...   73 tests OK 10.4s
# test_ctrdata_sqlite_isrctn.R..   31 tests OK 24.1s
# test_euctr_error_sample.R.....    9 tests OK 1.1s
# All ok, 413 results (29m 33.7s)
```
