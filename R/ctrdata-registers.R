...
#' @section 1 - Overview:
#'
#' - **EUCTR**: The EU Clinical Trials Register contains more than 44,100 clinical
...
#' for new clinical trials. It includes more than 6,200 publicly accessible trials.
...
#' - **CTGOV2**: ClinicalTrials.gov includes more than 510,000 interventional and
#' observational studies
#' - **ISRCTN**: The ISRCTN Registry includes more than 25,400 interventional and
