...
#' result-related information as well as documents, last updated 2026-04-18
#'
#' @section 1 - Overview:
#'
#' - **EUCTR**: The EU Clinical Trials Register is complete with 44,393
#' clinical trials (at least one investigational medicinal product, IMP; in
#' the European Union and beyond), including more than 26,060 trials with
#' results, which continue to be added.
#'
#' - **CTIS**: The EU Clinical Trials Information System, launched in 2023,
#' holds more than 11,350 publicly accessible clinical trials, including
#' more than 850 with results or a report.
...
#'
#' - **CTGOV2**: ClinicalTrials.gov holds more than 581,100 interventional and
#' observational studies, including almost 73,000 interventional studies
#' with results.
#'
#' - **ISRCTN**: The ISRCTN Registry holds more than 28,000 interventional and
#' observational health studies, including more than 15,200 studies with
#' results.
#'
