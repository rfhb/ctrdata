...
#' Specifying a parameter \code{collection = "<my collection's name>"} is
...
#'
#' @section 2 - Operate on trial registers:
#'
...
#'
#' @section 3 - Get data frame from collection:
#'
...
#'
#' @section 4 - Operate on a trial data frame:
#'
