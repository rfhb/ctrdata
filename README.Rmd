...
These are required for `ctrLoadQueryIntoDb()`, the main function of package `ctrdata` (see [Example workflow](#example-workflow)), to work with the registers EUCTR, CTGOV, ISRCTN (but are *not* required for `ctrdata` to work with the registers CTIS or CTGOV2).
