...
- ClinicalTrials.gov ("CTGOV" current`r emoji::emoji("bell")` and classic, https://classic.clinicaltrials.gov/)
...
`r emoji::emoji("bell")`Both the current and classical CTGOV website searches are supported as of 2023-08-05 when using the full URL. When queryterms such as in the next example are used, `ctrdata` guesses which interface to use, based on the parameters in the query. 
