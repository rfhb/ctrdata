...
- ClinicalTrials.gov ("CTGOV", current`r emoji::emoji("bell")` https://www.clinicaltrials.gov/ and classic https://classic.clinicaltrials.gov/)
...
`r emoji::emoji("bell")`Both the current and classic CTGOV website are supported as of 2023-08-05 when using the full URL. When a queryterm such as in the next example is used, `ctrdata` guesses which CTGOV interface to use, based on the parameters in the query. 
