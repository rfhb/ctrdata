...
* `r emoji::emoji("bell")`Queries in the registers are automatically copied to the clipboard (including for "CTIS", where the URL does not show the query) using a [browser extension](https://www.tampermonkey.net/) and our [user script](https://raw.githubusercontent.com/rfhb/ctrdata/tools/ctrdataURLcopier.js) NEW since 2023-04-15
