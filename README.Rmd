...
* `r emoji::emoji("bell")`Queries in the registers can be automatically copied to the clipboard (including for "CTIS", where the URL does not show the query), see [here](#id_3-script-to-automatically-copy-users-query-from-web-browser) NEW since 2023-04-15
