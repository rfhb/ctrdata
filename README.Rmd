...
A remote or a local mongo database server can be used with the package, see included tests and examples. 

Suggested installation instructions for a local database server are [here](https://docs.mongodb.com/manual/administration/install-community/). 
