...
* This package `ctrdata` has been made possible based on the work done for [curl](https://github.com/jeroenooms/curl), [clipr](https://github.com/mdlincoln/clipr), [mongolite](https://cran.r-project.org/package=mongolite) and [R](http://www.r-project.org/), [httr](https://cran.r-project.org/package=httr), [xml2](https://cran.r-project.org/package=xml2) and [rvest](https://cran.r-project.org/package=rvest).
