...
Last edit 2019-03-27 for version 0.17.0, with bug fixes and new features: 
...
In case of problems, a release version of package `ctrdata` can be downloaded [here](https://github.com/rfhb/ctrdata/releases) and installed from the downloaded archive. 

## 3. Mongo data base

Remote and local mongo servers can be used with the package, see included tests and examples. 
