...
The motivation is to understand trends in design and conduct of trials, their availability for patients and their detailled results. The package is to be used within the [R](https://www.r-project.org/) system; this README was reviewed on 2021-12-04 for v1.8.0.9000.
...
```
![Neuroblastoma trials](man/figures/README-ctrdata_results_neuroblastoma.png)
...
![Example JSON representation in MongoDB](man/figures/README-ctrdata_json_mongodb.jpg)

### SQLite

![Example JSON representation in SQLite](man/figures/README-ctrdata_json_sqlite.jpg)
