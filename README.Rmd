...
Last edit 2019-05-19 for version 0.18.9005, with bug fixes and new features: 
...
* works with remote Mongo databases; removed need for local installation of MongoDB. 
...
* This package `ctrdata` has been made possible based on the work done for [R](https://www.r-project.org/), [curl](https://github.com/jeroenooms/curl), [clipr](https://github.com/mdlincoln/clipr), [mongolite](https://cran.r-project.org/package=mongolite), [httr](https://cran.r-project.org/package=httr), [xml2](https://cran.r-project.org/package=xml2) and [rvest](https://cran.r-project.org/package=rvest).
