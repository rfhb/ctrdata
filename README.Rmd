...
- In macOS including up to 11 Big Sur, these are already installed; for macOS 12 Monterey and in case of errors, [`homebrew`](https://brew.sh/) can be used to install `php`. 
