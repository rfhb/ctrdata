...
#
result <- dbGetVariablesIntoDf(c("a1_member_state_concerned", "p_end_of_trial_status"))
#
...
tmp <- dfMergeTwoVariablesRelevel(result, 
                                  varnames = c("overall_status", "p_end_of_trial_status"))
...
## Analyse results-related information (INCOMPLETE)
...
m <- mongo(db = "users", collection = "resultsTest")
# 
# show full set of results
result <- m$find('{"_id": "NCT00089141"}')
str(result)
#
# extract some elements for illustration of further work needed
result$clinical_results$baseline$analyzed_list$analyzed$count_list$count
#
tbl <- result$clinical_results$outcome_list$outcome[[1]]
unlist(tbl[1,])
#
# EXCERPT
#
...
# description 
#  "Withdrawal of all systemic immunosuppressive treatment after resolution 
#   of chronic GVHD, before death or onset of recurrent malignancy" 
# time_frame 
#  "2 years" 
# group_list.group.title1 
#  "Mycophenolate Mofetil" 
# group_list.group.title2 
#  "Placebo" 
# measure.units 
#  "participants" 
# measure.param 
#  "Number" 
# measure.analyzed_list.analyzed.units 
#  "Participants" 
# measure.analyzed_list.analyzed.count_list.count.@attributes.value1 
#  "74" 
# measure.analyzed_list.analyzed.count_list.count.@attributes.value2 
#  "77" 
# analysis_list.analysis.non_inferiority_type 
#  "Superiority or Other" 
# analysis_list.analysis.p_value 
#  ".22" 
# analysis_list.analysis.p_value_desc 
#  "P values are 2 sided and are based on likelihood ratio statistics." 
# analysis_list.analysis.estimate_desc 
# "For all analyses, MMF arm in numerator, and placebo arm in denominator. 
#  Hazard ratio estimate includes 3 efficacy success events that occurred after 
#  two years in the placebo arm." 
#
```
