...
## Histogram of trial sponsors

```{r hist_trial_sponsors}
#
ctrLoadQueryIntoDb(register = "EUCTR", 
...
#
# get relevant trials
result <- result[relevant & result$e71_human_pharmacology_phase_i == "Yes",]
#
# adjust date format
...
tmp <- grepl("Yes", result$dimp.d21_imp_to_be_used_in_the_trial_has_a_marketing_authorisation) 
table(tmp)
#
# draw plot
library(ggplot2)
ggplot(data = result, 
  ...
  labs(title = "Paediatric phase 1 oncology trials", 
       x = "Year of clinical trial authorisation in EU", 
       y = "Number of clinical trials", 
       fill = "IMP authorised?")
# save plot
ggsave("phase1_paed_oncol.png", width = 5, height = 4)
#
```
