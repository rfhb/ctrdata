...
ctrLoadQueryIntoDb(queryterm = paste0("https://clinicaltrials.gov/ct2/results?rslt=With&age=0&intr=Drug&", 
                                      "phase=1&phase=2&strd_s=01%2F01%2F2010&strd_e=12%2F31%2F2012"), 
                                      collection = "resultsTest")

# get result set
result <- dbGetVariablesIntoDf(c("start_date", "condition", "detailed_description.textblock", "official_title",
                                 "study_design_info.allocation", "primary_outcome.measure", "oversight_info.has_dmc",
                                 "has_expanded_access", "completion_date", "primary_completion_date", 
                                 "results_first_submitted", "arm_group.arm_group_type", "phase",
                                 "clinical_results.outcome_list.outcome.measure.param",
...
# only certain trials, those that are likely to investigate safety and efficacy
