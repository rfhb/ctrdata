...
# 1 2021-04-02 12:03:06          EUCTR           135
# 2 2021-04-02 12:03:11          CTGOV           194
#                                          query-term
...
# * Total of 331 records in collection.
...
#  - 11 CTGOV secondary_id / nct_alias / org_study_id in EUCTR a41_sponsors_protocol_...
# Concatenating 37 records from EUCTR and 183 from CTGOV:
# = Returning keys (_id) of 220 out of total 233 records in collection "my_collection_name".
```
...
str(result)
# 'data.frame':	331 obs. of  4 variables:
#  $ _id                                  : chr  "2004-004386-15-DE" "2004-004386-15-ES" ...
#  $ annotation                           : chr  NA NA NA NA ...
#  $ record_last_import                   : Date, format: "2021-03-21" "2021-03-21" ...
#  $ clinical_results.outcome_list.outcome:List of 331
```
...
# [...]
# Concatenating 37 records from EUCTR and 181 from CTGOV
...
# Total 67278 rows, 182 unique names of variables
...
#  $ _id       : chr  "2010-019348-37-GB" "2010-019348-37-GB" " ...
#  $ identifier: chr  "8.2" "8.3" "8.5" "6.1" ...
#  $ name      : chr  "endPoints.endPoint.armReportingGroups[...]" ...
#  $ value     : num  7.03 8.08 4.86 999 999 999 ...
...
result <- dbGetFieldsIntoDf(
  ...
  con = db)
# [...]
# * Simplified or collapsed with '/' [3]:
#    'dimp.d21_imp_to_be_used_in_the_trial_has_a_marketing_authorisation'
