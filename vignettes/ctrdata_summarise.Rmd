...
ctrLoadQueryIntoDb(
  ...
  queryterm = "query=neuroblastoma&age=under-18&resultsstatus=trials-with-results",
  register = "EUCTR",
  euctrresults = TRUE,
  con = db
)
...
# * Checking trials using CTGOV REST API 2.0, found 236 trials
# (1/3) Downloading in 1 batch(es) (max. 1000 trials each; estimate: 24 Mb total)
# Download status: 1 done; 0 in progress. Total size: 10.41 Mb (597%)... done!             
# (2/3) Converting to NDJSON...
# (3/3) Importing records into database...
# JSON file #: 1 / 1                               
# = Imported or updated 236 trial(s)
...
# 1 2025-02-23 20:29:47          EUCTR           164
# 2 2025-02-23 20:29:49         CTGOV2           236
#                                                           query-term
# 1 query=neuroblastoma&age=under-18&resultsstatus=trials-with-results
# 2      cond=neuroblastoma&intr=Drug&aggFilters=ages:child,status:com
```
...
# - Getting all trial identifiers (may take some time), 400 found in collection
# - Finding duplicates among registers' and sponsor ids...
# - 115 EUCTR _id were not preferred EU Member State record for 52 trials
# - Keeping 49 / 0 / 0 / 0 / 218 records from EUCTR / CTGOV / ISRCTN / CTIS / CTGOV2
# = Returning keys (_id) of 267 records in collection "my_collection_name"
...
# - Finding duplicates among registers' and sponsor ids... 
# - 81 EUCTR _id were not preferred EU Member State record for 43 trials
# - Keeping 236 / 31 / 0 / 0 / 0 records from CTGOV2 / EUCTR / CTGOV / ISRCTN / CTIS
...
# 
# $success
#  [1] "2024-520436-15-00" "2024-519089-32-02" "2024-514917-36-00" "2024-518931-12-00"
#  [5] "2023-504246-64-02" "2024-517295-37-00" "2024-513470-22-00" "2024-513843-10-00"
#  [9] "2022-501694-39-01" "2024-511404-17-00" "2024-511975-14-00" "2024-512102-25-00"
# [13] "2024-515552-21-00" "2024-511259-16-00" "2023-507418-28-00" "2023-509673-22-00"
# [17] "2024-513141-37-00" "2024-511071-16-00" "2024-512095-35-00" "2023-507178-41-00"
# [21] "2023-506778-11-00" "2022-501725-21-00" "2023-504880-18-00" "2023-508587-29-00"
# [25] "2022-502668-20-00" "2023-504246-64-00" "2023-503684-42-00"
# 
# $failed
# NULL
```
...
# - Finding duplicates among registers' and sponsor ids... 
# - 81 EUCTR _id were not preferred EU Member State record for 43 trials
# - Keeping 236 / 31 / 0 / 0 / 27 records from CTGOV2 / EUCTR / CTGOV / ISRCTN / CTIS
...
dfCalculateConcept(name = ".isMedIntervTrial")
#
# >>>> .isMedIntervTrial
# 
# * Description:
...
str(result)
# 'data.frame':	471 obs. of  3 variables:
#  $ _id               : chr  "2004-004386-15-DE" "2004-004386-15-ES" "2004-004386-15-GB" "2004-004386-15-IT" ...
#  $ record_last_import: Date, format: "2025-02-23" "2025-02-23" "2025-02-23" ...
...
# Total 130350 rows, 157 unique names of variables
...
# Returning values for 50 out of 145 trials
...
#    <chr>               <chr>                                                            <chr>     <dbl>
#  1 2010-022951-49-LV_2 Progression-free Survival                                        "Arm-648…   108
#  2 2010-022951-49-LV_2 Progression-free Survival                                        "Arm-648…    51
#  3 2010-022951-49-LV_4 Progression Free Survival (PFS) in Participants with Wild-type … "Arm-648…   156
#  4 2010-022951-49-LV_4 Progression Free Survival (PFS) in Participants with Wild-type … "Arm-648…    51
...
#  9 2013-003595-12-HU_3 Progression Free Survival (PFS) as assessed by the Investigator… "Arm-115…    54
# 10 2013-003595-12-HU_3 Progression Free Survival (PFS) as assessed by the Investigator… "Arm-115…    54
```
...
m$count(query = '{"_id": {"$regex": "[0-9]{4}-[0-9]{6}-[0-9RD]{2,3}", "$options": "i"}}')
# [1] 235
