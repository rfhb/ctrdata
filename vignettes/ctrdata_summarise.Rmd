...
For CTGOV2 records, the historic version are added as follows into the `ctrdata` data model of a trial record, where the ellipsis `...` represents all trial data fields: 
