...
# 71 downloaded, extracting x x x x x . x . PDF . . . x . . . x PDF . PDF . . PDF . x . .
# x . . x x . . x . . . . . . . . . . . . . . x . . . . . . PDF . . . . . . . . . . . .
# PDF . . . . . PDF . PDF .
...
# Warning message:
# [...]/ctrDATA15bc13c33351a/ctgov_trials_7.ndjson: Error : C stack usage  8342562 is too close to the limit
```
