...
# * Checking trials in EUCTR: Retrieved overview, multiple records of 63 trial(s) from 4 page(s) to be downloaded.
...
# = Imported or updated 232 records on 63 trial(s).
...
# 1 2021-04-02 11:48:10          EUCTR           232 
#                                                     query-term
...
# [...]
# * Retrieve results if available from EUCTR for 63 trials: 
# (1/4) Downloading results (max. 10 trials in parallel):
#  t 1-10 x x x x x x . PDF . . PDF . 
#  t 11-20 x x x x . . . . PDF . . 
#  t 21-30 x . x x x . . PDF . . . 
#  t 31-40 x x . . . . PDF . . . . 
#  t 41-50 x x . . . PDF . . . . . 
...
# (4/4) Retrieving results history: not done (euctrresultshistory = FALSE).
# = Imported or updated results for 159 records for 63 trial(s).
```
...
# Retrieved overview, records of 194 trial(s) are to be downloaded.
# Checking helper binaries: . . . done.
# Downloading: 1.2 MB       
# (2/3) Converting to JSON...
# (3/3) Importing JSON records into database...
# = Imported or updated 194 trial(s). 
# * Updated history in meta-info of "test"
# [...]
# attr(,"ctrdata-dbqueryhistory")
#       query-timestamp query-register query-records
# 1 2021-03-21 08:01:38          EUCTR           232
# 2 2021-03-21 08:03:37          EUCTR           232
# 3 2021-03-21 08:04:50          CTGOV           196
#                                                   query-term
# 1 query=cancer&age=under-18&status=completed&phase=phase-one
# 2 query=cancer&age=under-18&status=completed&phase=phase-one
# 3                 cond=neuroblastoma&recrs=e&age=0&intr=Drug
```
...
# [...]
# = Annotated retrieved records#: 1 / 1
