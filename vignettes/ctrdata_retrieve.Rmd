...
q <- ctrGetQueryUrl()
# * Using clipboard content as register query URL: https://www.clinicaltrialsregister.eu/ctr-search/search?query=cancer&age=under-18&resultsstatus=trials-with-results
...
# Retrieved overview, multiple records of 118 trial(s) from 6 page(s) to be downloaded (estimate: 20 MB)
# [1] 376
...
# 1 2025-02-23 20:45:27          EUCTR          1470
#                                                    query-term
...
# Download status: 292 done; 0 in progress. Total size: 54.42 Mb (100%)... done!             
# Download status: 208 done; 0 in progress. Total size: 38.73 Mb (100%)... done!             
# Download status: 128 done; 0 in progress. Total size: 42.50 Mb (100%)... done!             
# Download status: 40 done; 0 in progress. Total size: 23.10 Mb (100%)... done!             
...
With a file-base SQLite database, this takes about 30 seconds for about 500 records; it is similarly fast with MongoDB and PostgreSQL.
...
With a file-based SQLite database, this takes a few seconds for more than 200 records.
...
```{r}
ctrLoadQueryIntoDb(
  queryterm = "cond=neuroblastoma&country=Germany&aggFilters=ages:child,studyType:int,status:com",
  register = "CTGOV2",
...
# * Found search query from CTGOV2: cond=neuroblastoma&country=Germany&aggFilters=ages:child,studyType:int,status:com
...
#  [4] "CGP 57148"                   "CGP 57148B"                  "CGP-57148"                  
#  [7] "CGP-57148B"                  "CGP57148"                    "CGP57148B"                  
# [10] "Gleevac"                     "gleevec"                     "Gleevec (Imatinib Mesylate)"
# [13] "Glevec"                      "glivec"                      "Imarech"                    
# [16] "Imat"                        "Imatinib"                    "imatinib mesylate"          
# [19] "Imatinib-AFT"                "Impentri"                    "IND # 55666"                
# [22] "NSC-716051"                  "QTI571"                      "ST1571"                     
# [25] "STI 571"                     "STI-571"                     "STI571"                     
# [28] "tyrosine kinase inhibitors"  "Ziatir"                      "Zoleta"  
```
