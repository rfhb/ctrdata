...
The ommand line tools `perl`, `sed` and `php` (5.2 or higher) are required for `ctrLoadQueryIntoDb()`, the main function of package `ctrdata`. No other function in this package has this requirement.
...
The command line tools `perl`, `sed` and `php` (5.2 or higher) are typically installed and available by default in Linux and macOS systems. In case of issues, 

- In macOS, [`homebrew`](https://brew.sh/) can be used to install `php` which may be needed starting from macOS 12 Monterey 
