...
The R Project website ([https://www.r-project.org/](https://www.r-project.org/)) provides installers for the R system. It can be used with software products and graphical user interfaces such as [R Studio](https://posit.co/products/open-source/rstudio/), or from [Visual Studio Code](https://marketplace.visualstudio.com/items?itemName=REditorSupport.r). 
