...
At this time, a PostgreSQL, an SQLite or a remote or a local MongoDB database can be used with the package `ctrdata`. SQLite is provided in the R package [`RSQLite`](https://rsqlite.r-dbi.org/). Suggested installation instructions for a local MongoDB server are [here](https://docs.mongodb.com/manual/administration/install-community/); a remote MongoDB database server is accessible [here](https://www.mongodb.com/cloud/atlas). 
