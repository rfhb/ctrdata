...
If internet acccess has to be via a proxy and this was not correctly detected automatically, it can be specified for the installation of cygwin as follows: 
